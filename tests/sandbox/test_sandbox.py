...
def plan():
    call = ToolCall(task_id="t", step_id=0, tool_name="restricted_command", arguments={"command": ["python3", "-V"]})
    return ExecutionPlan(effective_call=call, target=ExecutionTarget.CONTAINER, sandbox_profile="isolated_compute", validated=True)
